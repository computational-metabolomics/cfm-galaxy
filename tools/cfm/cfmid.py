        ...
        if numlines == 0:
            ...
            if linesread == numlines:
                ...
                if len(cand_id_list) > 0:
                    ...
                    if args.polarity == "pos":
                        cmd_command += os.path.join(args.tool_directory, "data", "positive_metab_se_cfm", "param_output0.log") + " "
                        cmd_command += os.path.join(args.tool_directory, "data", "positive_metab_se_cfm", "param_config.txt") + " "
                    else:
                        cmd_command += os.path.join(args.tool_directory, "data", "negative_metab_se_cfm/param_output0.log") + " "
                        cmd_command += os.path.join(args.tool_directory, "data", "negative_metab_se_cfm/param_config.txt") + " "
